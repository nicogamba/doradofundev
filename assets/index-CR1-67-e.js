(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const l of n)if(l.type==="childList")for(const c of l.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function s(n){const l={};return n.integrity&&(l.integrity=n.integrity),n.referrerPolicy&&(l.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?l.credentials="include":n.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function r(n){if(n.ep)return;n.ep=!0;const l=s(n);fetch(n.href,l)}})();const y={ui:{siteTitle:"doradofundev",tagline:"Videojuegos hechos por mí, para jugar en el navegador.",catalogTitle:"Catálogo de juegos",catalogEmpty:"Todavía no hay juegos. Vuelve pronto.",play:"Jugar",back:"Volver al catálogo",fullscreen:"Pantalla completa",exitFullscreen:"Salir de pantalla completa",language:"Idioma",gameNotFound:"No se encontró ese juego."},games:{voleyaslife:{title:"VoleyAsLife",desc:"Tu carrera en el vóley: elegí tu posición, jugá la eliminatoria nacional y tomá decisiones en los momentos clave."},looking4stars:{title:"Looking4Stars",desc:"Lanza las bolas, destruye los asteroides y rescata a todos los aliens antes de quedarte sin bolas."},cuatrolocks:{title:"cuatrolocks",desc:"Tetris de construcciones: liberá las llaves escondidas en los bloques y dispará explosiones encadenadas."},ejemploCuadritos:{title:"Cuadritos",desc:"Muévete con las flechas del teclado y recoge los puntos dorados antes de que se acabe el tiempo."}}},h={ui:{siteTitle:"doradofundev",tagline:"Games made by me, playable in your browser.",catalogTitle:"Game catalog",catalogEmpty:"No games yet. Check back soon.",play:"Play",back:"Back to catalog",fullscreen:"Fullscreen",exitFullscreen:"Exit fullscreen",language:"Language",gameNotFound:"That game was not found."},games:{voleyaslife:{title:"VoleyAsLife",desc:"Your volleyball career: pick your position, play the national knockout and make decisions at the key moments."},looking4stars:{title:"Looking4Stars",desc:"Shoot the balls, destroy the asteroids and rescue all the aliens before you run out of balls."},cuatrolocks:{title:"cuatrolocks",desc:"Block puzzles: free the keys hidden in the stacks and trigger chained explosions."},ejemploCuadritos:{title:"Little Squares",desc:"Move with the arrow keys and collect the golden dots before time runs out."}}},m="doradofundev.lang",b={es:y,en:h};let i=v();const u=new Set;function v(){return localStorage.getItem(m)==="en"?"en":"es"}function g(e,t){let s=b[e];for(const r of t.split(".")){if(s===null||typeof s!="object")return;s=s[r]}return typeof s=="string"?s:void 0}function o(e){return g(i,e)??g("es",e)??e}function f(){return i}function $(e){e!==i&&(i=e,localStorage.setItem(m,e),u.forEach(t=>t()))}function k(e){return u.add(e),()=>u.delete(e)}const p=[{id:"voleyaslife",titleKey:"games.voleyaslife.title",descKey:"games.voleyaslife.desc",thumb:"games/voleyaslife/thumb.svg",orientation:"portrait"},{id:"cuatrolocks",titleKey:"games.cuatrolocks.title",descKey:"games.cuatrolocks.desc",thumb:"games/cuatrolocks/thumb.svg",orientation:"portrait"},{id:"looking4stars",titleKey:"games.looking4stars.title",descKey:"games.looking4stars.desc",thumb:"games/looking4stars/thumb.svg",orientation:"portrait"},{id:"ejemplo-cuadritos",titleKey:"games.ejemploCuadritos.title",descKey:"games.ejemploCuadritos.desc",thumb:"games/ejemplo-cuadritos/thumb.svg"}];function L(e){return p.find(t=>t.id===e)}function E(){const e=location.hash.replace(/^#\/?/,"").split("/").filter(Boolean);return e[0]==="juego"&&e[1]?{page:"game",id:e[1]}:{page:"catalog"}}function a(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function j(){const e=f(),t=s=>`<button class="lang-btn${e===s?" is-active":""}" data-lang="${s}" type="button">${s.toUpperCase()}</button>`;return`
    <header class="header">
    ...
    </main>`}function K(e){const t=L(e);if(!t)return`
      <main class="view">
        <section class="catalog">
    ...
    </main>`}function d(){const e=document.getElementById("app");e&&(document.documentElement.lang=f(),e.innerHTML=`${j()}${S(E())}`,T(),window.scrollTo(0,0))}function S(e){return e.page==="game"?K(e.id):w()}function T(){document.querySelectorAll(".lang-btn").forEach(t=>{t.addEventListener("click",()=>$(t.dataset.lang))});const e=document.querySelector(".btn-fullscreen");e&&e.addEventListener("click",()=>{const t=document.getElementById("game-frame");t&&(document.fullscreenElement?document.exitFullscreen():t.requestFullscreen())})}function C(){const e=document.querySelector(".btn-fullscreen");e&&(e.textContent=document.fullscreenElement?o("ui.exitFullscreen"):o("ui.fullscreen"))}k(d);window.addEventListener("hashchange",d);document.addEventListener("fullscreenchange",C);d();
